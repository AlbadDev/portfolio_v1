export const projectInfo = [
  {
      ...
      material: ['React', 'TypeScript', 'MaterialUi'],
      mvp: ['Fisrt of all the user need to login with our default username and password : " pikachu " .',
            ...
            'To add new pokemon remplace these 3 xxx in the link with any number add a name, score, genre, damage and click to the validate button in the bottom.',
            'When an information is wrong or empty after you submit the form, an error will throw ',
            'User can edit a pokemon and set new value for it like : name, score, genre, damage.',
            'Posiblity to delete an specific pokemon'
          ],
      inDeep: ['For a better page navigation, I used react-router to navigate between page.',
              'To take 12 pokemons persistant in our app I used json-server as the best tool to handle data persistance.',
    ...
    },
  {
      ...
      mvp: ['GitHub Viewer start with an search bar input field.',
            'Enter a GitHub user to the search bar and click Enter.',
            'This app get started with a preety look of the the user profil informations : 1. personal informations like : profil picture, real name, location, company, etc...  2. GitHub repositories informations like : number of repos, number of follerwers and following etc... .',
            'A pretty Data visualization, the graphical representation of information and data like the user most used programming language etc.. .',
            'A clean list of the user public repositories and information of any repos displayed into an individual card.',
            'User can sort all the user repopositories by size, number of forks or number of stars by using the dropdown button in the top of the list of repositories.'
          ],
      inDeep: ['To get real data to any GitHub account, I use the GitHub data API.',
                   'I used feth for data fething and use request status for error handling',
                   'For data visualization, I used Chartjs.',
                   'Saas for styling and React Hook for data management.',
  ...
  },
  {
      ...
      mvp: ['Portfolio V1 is a single page application.',
            ...
            'An About page , here I inter in deep about my self starting with a picture of my self, my full name, a paraphram of text saying about my background in tech and at the end the list of technologies That I have working recently.',
            'A Work page section, a page where I have listed some of my recent personal work I have done using my recent stack.',
            'You have the ablity to click in each work name to see the live project in the internet, or click to the eye icon to go in deep to the project in a different page where you can see how the project get done with full tecno specification and style guide .',
            'My resume page, here I build my resume from scratch using but you can also download my white paper resume .',
            'Inside my resume page you use a form I build to send me email or connect me to my LinkedIn page. '
          ],
      inDeep: ['Next.js is a react framwork to build scalable static and dynamic site for fast web app and better SEO.',
               ...
               'I used the asynchronous getStaticProps function and fetch for data fetching and management.',
  ...
  },
  {
      ...
      mvp: ['Stark Search start with a search bar input field.',
            ...
            'Click to the result and get redirect to the wikipedia page.'],
