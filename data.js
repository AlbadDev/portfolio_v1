export const projectInfo = [
  {
      ...
      mvp: ['Fisrt of all the user need to login with our default username and password : " pikachu " build with Firebase Authentication',
    ...
    },
  {
      ...
      mvp: ['GitHub Viewer start with an search bar input field.',
            ...
            'This app get started with a preety look user profil informations : 1. personal informations like : profil picture, real name, location, company, etc...  2. GitHub repositories informations like : number of repos, number of follerwers and following etc... .',
  ...
  },
  {
      ...
      mvp: ['Portfolio V1 is a single page application.',
            ...
            'An About page , here I inter in deep about my self starting with a picture of my self, my full name, a paragraph of text saying about my background in tech and at the end the list of technologies That I have working recently.',
